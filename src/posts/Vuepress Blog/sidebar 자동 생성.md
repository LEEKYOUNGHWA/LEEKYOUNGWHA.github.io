...
vuepress에서 기본으로 제공하는 `sidebar: 'auto'` 옵션은 는 한 페이지만 나오는 거였다 ㅠㅠ  여러 블로그랑 npm package를 봤는데 전부 다 내가 원하는 모양새는 아니었다.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc2MjIwOTA2Miw3MzA0MjY1MjNdfQ==
-->